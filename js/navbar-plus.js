document.addEventListener('DOMContentLoaded', ()=>{
    ...
    const bgColors = ['bg-primary','bg-secondary','bg-info','bg-danger','bg-warning','bg-success','bg-light','bg-white','bg-dark'];
    let colorTheme = obtenerColor($navBar.parentElement.classList, bgColors);
    ...
    if($navBar.dataset.sideColor !== undefined){
        sideBarColor = $navBar.dataset.sideColor;
    }else{
        sideBarColor = '';
    }
    ...
    //EVENTO NO REQUERIDO: es para el ejemplo en general sin consultar a ningun sitio
    ...
    //cargarDatosUsuario();//Aqui cargamos la foto de perfil segun los datos (no tan importantes) al iniciar sesision guardados en localstorage
    ...
    function obtenerColor(domTokenListColor, bgColors){
        let picker;
